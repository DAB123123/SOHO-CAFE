...
<html lang="en">
  ...
  <?php require_once 'nav.php' ?> <!-- / .navbar -->
	...
	<!-- CAROUSEL
	================================================== -->
	<section class="section section_carousel section_border_bottom">
		<div class="container">
			<div class="row">
				<div class="col">
		...
		<div class="container">
			...
			<div class="row section_gallery__grid">
				...
				<div class="col-6 col-sm-6 col-md-4 section_gallery__grid__item">
					...
					<a href="assets/img/cong.jpg" data-lightbox="gallery">
						<img src="assets/img/cong.jpg" class="img-fluid" alt="...">
					</a>
				...
				<div class="col-6 col-sm-6 col-md-4 section_gallery__grid__item">
					...
					<a href="assets/img/docalvin.jpg" data-lightbox="gallery">
						<img src="assets/img/docalvin.jpg" class="img-fluid" alt="...">
					</a>
