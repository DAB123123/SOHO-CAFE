              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Dish Name" name="name" id="name" required>
                  </div>
                </div>
                <!--/span-->
                <div class="col-md-6">
             ...
             <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control p-20" rows="4" id="description" name="description" maxlength="250" placeholder="Add Description" required></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <div class="product-img text-start">
                    <img src="assets/img/menu/sample.png" alt="" class="mb-15 img_size"  id="output">
