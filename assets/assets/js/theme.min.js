...
var Navbar = (function () {
    ...
    function s() {
      ...
      $("#navbar-heading-collapse").text("SOHO CAFE");
    }

    function i() {
      e.removeClass("navbar-dark").addClass("navbar-light");
      $("#navbar-heading-collapse").text("");
    }
    ...
    n.on("submit", function (e) {
      e.preventDefault(),
        $.ajax({
          ...
          error: function (e) {
            $(document).trigger("touche.alert.show", [
              "danger",
          ...
          success: function (e) {
            if ("success" != e.result) {
              ...
              $(document).trigger("touche.alert.show", ["success", e.msg]),
                n[0].reset();
          },
        });
    }),
